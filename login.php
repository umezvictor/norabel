...
if(isset($_POST['login'])){
   ...
   $handler->checklogin($user, $pass, $remember);
...
<div class="login-form"> 
    ...
    <form action="login.php" method="post">
    	...
    	<h4 class="modal-title">Norabel Admin</h4>
        ...
        <input type="submit" class="btn btn-primary btn-block btn-lg" name="login" id="login" value="Login">              
    </form>			
